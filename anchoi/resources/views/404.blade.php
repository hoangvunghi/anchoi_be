...
<body class="bg-gray-100 dark:bg-gray-900">
    ...
    <a href="/contact" class="text-gray-800 dark:text-white hover:underline">Liên hệ</a>
        ...
        <main class="container mx-auto px-4 py-8 flex-grow  pt-20"> 

            @include('search')

            <section class="py-4">
                <div class="flex flex-row items-end gap-4">
                    <h2 class="text-2xl font-semibold">{{$title}} đang được cập nhật</h2>
                </div>

                    <h1>Vui lòng quay lại sau hoặc thử tìm kiếm các loại hình khác</h1>
                ...
                if (navigator.geolocation) {
                    navigator.geolocation.getCurrentPosition(
                        (position) => {
                            ...
                            .then(data => console.log("Vị trí đã được lưu vào session."))
                            .catch(error => console.error("Lỗi khi lưu vị trí vào session:", error));
                        },
